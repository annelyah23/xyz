...
echo -e "\033[0;36m╚======================================================╝${NC}"
echo -e "     \033[35;1m      MULTIPORT WEBSOCKET BY \033[0;33m${bold}JsPhantom \033[0m"
echo -e "\033[0;36m•======================================================•${NC}"
echo -e "\e[36m╔======================================================╗\033[0m"
echo -e " \033[35;1m             \033[0;33m  \033[35;1m      INFO SERVER \033[0;33m              \033[0m"
echo -e "\e[36m╚======================================================╝\033[0m"
...
echo -e " \033[0;33m${bold}Domain          \033[0;32m   :  ${bold}\033[0;34m$domain"
...
echo -e " ${NC}[\033[1;36m•24\033[0m]  ${bold}Update Autoscript To V$serverV\n"
up2u="updatews"
else
up2u="menu"
fi
